...
const Card = ({ title, subtitle, Icon }) => {
  return (
    ...
    >
      ...
      <h3 className="font-roboto-serif font-semibold text-base sm:text-2xl text-black group-hover:text-white transition-colors duration-300 relative z-10">
        {title}
      </h3>
      <p className="text-[#333333] group-hover:text-white/90 text-xs sm:text-sm md:text-lg font-roboto leading-relaxed transition-colors duration-300 relative z-10">
        {subtitle}
      </p>
    </div>
  );
