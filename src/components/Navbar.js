...
const Buttons = ({ setMenuOpen }) => (
	<div className="flex items-center gap-2 sm:gap-4">
		...
		<WetPaintButton text="Request Quote" href="/contact-us" className="hidden md:inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2 text-white font-montserrat font-medium text-sm sm:text-base rounded-md whitespace-nowrap" size="sm" />
		<button
