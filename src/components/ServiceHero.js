  ...
  return (
    <div className="relative  z-20 mx-auto flex max-w-7xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-10">{/* standardized container */}
      ...
      <motion.h1
        ...
        className="mb-3 text-center text-2xl font-bold leading-tight text-zinc-50 sm:text-4xl sm:leading-tight md:text-3xl md:leading-tight lg:text-5xl lg:leading-tight"
      >
       our services
      </motion.h1>
      <motion.p
...
const Beam = ({ top, left, transition = {} }) => {
  return (
    <motion.div
      ...
      className="absolute z-10 h-[64px] w-[4px] bg-gradient-to-b from-green-500/0 to-green-400"
    />
  );
};
  ...
  return (
    ...
    >
      <div
        ...
        className="absolute inset-0 z-0"
      />
      <div className="absolute inset-0 z-10 bg-gradient-to-b from-green-950/0 to-green-950" />
    </motion.div>
  );
};
