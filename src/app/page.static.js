        ...
        {teasers.map((p) => (
          ...
          >
            ...
            <div className="p-5 sm:p-6">
              <p className="text-xs uppercase tracking-wide text-[#3AA335] font-semibold mb-2">{p.category}</p>
              <h3 className="font-montserrat font-bold text-black text-lg sm:text-xl mb-2">{p.companyName}</h3>
